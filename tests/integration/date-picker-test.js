...
module('Integration | Component | date picker', function (hooks) {
  ...
  test('it can clear selected date and reset calendar', async function (assert) {
    ...
    assert.dom('[data-test-cs-component-input="date-picker"]').hasValue('');
    assert.dom('[data-test-cs-component-label="date-picker"]').hasText('Enter date');
    assert.dom('[data-test-cs-component-calendar-nav-months]').hasText(month);
    assert.dom('[data-test-cs-component-calendar-nav-years]').hasText(year);
  ...
  test('it can render the themed component', async function (assert) {
    await render(hbs`<DatePicker @label="Pick a date" @theme="cs-dark" />`);

    assert.dom('[data-test-cs-component="date-picker"]').hasClass('cs-dark');
    assert.dom('[data-test-cs-component-input="date-picker"]').hasClass('cs-dark-input');
  });
  ...
  test('it renders in view mode', async function (assert) {
    ...
    assert.dom('[data-test-cs-component-label="date-picker"]').hasText('When is Judgment Day?');
